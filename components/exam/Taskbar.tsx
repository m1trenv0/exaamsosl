  ...
  return (
    <div className="windows-taskbar">
      ...
      <div className="flex items-center gap-3 text-white">
        ...
        <div className="font-semibold text-[14px]">EN</div>
        ...
        <button className="bg-[#e85e13] text-white h-[34px] px-[18px] rounded-md font-semibold text-[14px] flex items-center gap-2 hover:bg-[#d44d08] transition-colors">
